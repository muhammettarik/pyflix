...
class moviePage:
    def __init__(self,user,master):
        ...
        self.win.grab_set()
        self.win.title(self.i18n.movie_page_title)
    ...
    def on_double_click(self, e):
        ...
        movieDetailedPage.movieDetailed(mid=item, parent=self, user=self.current_user)
